...
<div class="alert alert-info border-0 shadow-sm rounded-3 d-flex align-items-center">
    ...
    <input type="text" id="buscador-profesores" class="form-control border-0 bg-transparent shadow-none" placeholder="Buscar por nombre o número de empleado/boleta...">
</div>
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody id="tbody-profesores">
                    <tr><td colspan="4" class="text-center py-4 text-muted"><span class="spinner-border spinner-border-sm text-primary me-2"></span>Cargando profesores...</td></tr>
                </tbody>
            </table>
        </div>
    </div>
        ...
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-body">
                <form id="form-nuevo-profesor">
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            <label class="form-label">No. Empleado (Boleta)</label>
                            <input type="text" class="form-control" id="prof-boleta" required>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control" id="prof-paterno" required>
                        </div>
                        <div class="col-6">
                            <label class="form-label">Apellido Materno</label>
                            <input type="text" class="form-control" id="prof-materno" required>
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <input type="email" class="form-control" id="prof-correo" placeholder="ejemplo@ipn.mx" required>
                        </div>
                        <div class="col-12">
                            <label class="form-label">Contraseña Temporal</label>
                            <input type="text" class="form-control" id="prof-password" value="IPN2026" required>
                        </div>
                    </div>
                </form>
            </div>
