...
<div class="d-flex justify-content-between mb-3">
    <input type="text" id="buscador-examenes" class="form-control w-25 shadow-sm" placeholder="Buscar materia o profesor...">
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody id="tbody-examenes">
                    <tr><td colspan="8" class="text-center py-4 text-muted">Aún no hay exámenes programados.</td></tr>
                </tbody>
            </table>
        </div>
    </div>
...
<div class="modal fade" id="modalNuevoETS" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow">
            <div class="modal-header bg-success text-white border-bottom-0">
                <h5 class="modal-title fw-bold"><i class="bi bi-calendar-plus me-2"></i>Programar Nuevo ETS</h5>
...
<div class="modal fade" id="modalEditarETS" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow">
            <div class="modal-header bg-warning text-dark border-bottom-0">
                <h5 class="modal-title fw-bold"><i class="bi bi-pencil-square me-2"></i>Editar Examen Programado</h5>
